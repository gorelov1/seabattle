 ...
 */
import { CellStatus, ShotError, ShotOutcome, Column, } from "./types.js";
 ...
 * Requirements: 6.1, 6.2, 6.3, 6.4, 6.5, 8.1, 8.2, 8.3, 8.4, 10.3, 10.4
 */
export function processShot(board, coord) {
    ...
    const hitShipIndex = board.ships.findIndex((ship) => ship.cells.some((c) => serialize(c) === key));
    if (hitShipIndex === -1) {
        // -----------------------------------------------------------------------
    ...
    const newShips = board.ships.map((ship, idx) => idx === hitShipIndex ? updatedShip : ship);
...
//# sourceMappingURL=shotEngine.js.map