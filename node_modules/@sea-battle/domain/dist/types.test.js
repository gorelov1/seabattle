...
import { Column, CellStatus, ShipType, TurnPhase, ShotOutcome, PlacementError, ShotError, Orientation, FLEET_SPEC, shipSize, } from "./types.js";
...
describe("FLEET_SPEC", () => {
    ...
    it("totals 10 ships", () => {
        const total = FLEET_SPEC.battleships +
            FLEET_SPEC.cruisers +
    ...
    it("totals 20 segments", () => {
        const segments = FLEET_SPEC.battleships * shipSize(ShipType.Battleship) +
...
describe("Result type", () => {
    it("can represent success", () => {
        const ok = { ok: true, value: 42 };
        expect(ok.ok).toBe(true);
        expect(ok.value).toBe(42);
    });
    it("can represent failure", () => {
        const err = { ok: false, error: "something went wrong" };
...
describe("Option type", () => {
    it("can represent Some", () => {
        const some = { some: true, value: "hello" };
