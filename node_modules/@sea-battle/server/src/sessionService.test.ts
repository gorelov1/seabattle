...
import { SessionService, type SessionQueries } from "./sessionService.js";
...
describe("SessionService.createSession", () => {
  ...
  let store: ReturnType<typeof createInMemorySessionQueries>;
...
describe("SessionService.updateSession", () => {
  ...
  it("persists changes made to a session", () => {
    ...
    const updated = { ...created, status: "Shooting" as const };
